...
public class FileMergeGUI extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        gridPane.add(new Label("Enter or choose a file: "), 0, 0);
        ...
        Scene scene = new Scene(vBox, 500, 320);
        primaryStage.setTitle("FileMergeGUI"); // Set the stage title
